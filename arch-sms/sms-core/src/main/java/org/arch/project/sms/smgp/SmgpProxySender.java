...
//@Slf4j
//@Service
//public class SmgpProxySender extends AbstractSmsProxySender implements SmsProxySendable {
//
//    /**
//     * 对于Proxy分发短信的接收
//     *
...
//                log.error("SMGP 代理获取失败，手机号码：{}， 短信内容：{}，扩展号码：{}", mobile, content, extNumber);
//
//                return null;
//            }
//
...
//                log.error("SMGPSubmitRespMessage 网关提交信息为空");
...
//
//            if (submitRepMsg == null) {
//                log.error(" SmgpSubmitRepMessage null, submitMsg : {}", submitMsg);
//            } else if (submitRepMsg.getStatus() != 0) {
//                log.error(" submitRepMsg result :{}, index : {}, content: {}, mobile : {}", submitRepMsg.getStatus(),
...
//            // 解析返回结果并返回
//        } catch (Exception e) {
//            log.error("SMGP状态回执解析失败：{}", JSON.toJSONString(report), e);
...
//
//        } catch (Exception e) {
//            log.error("SMGP上行解析失败 {}", JSON.toJSONString(report), e);
