...
//			List<XMind> allObjList = new ArrayList<>();
...
//	 * @param allCaseList
//	 */
//	public static void getLeafObjList(List<XMind> allObjList, List<List<String>> allCaseList) {
//
//		// 复制该集合
//		List<XMind> copyObjList = new ArrayList<>(allObjList);
//
//		// 遍历两个集合，找出叶子对象
//		for (XMind leafObj : copyObjList) {
//			// 假设leafObj是叶子对象，flag为true
//			boolean flag = true;
//			for (XMind all : allObjList) {
