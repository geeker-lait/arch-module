...
public class ExcelSchemaReader extends AbstractSchemaReader implements SchemaReadable {
    ...
    @Override
    protected List<? extends SchemaData> readDatabse(ReaderConfiguration readerConfiguration) {
        return null;
    }

    @Override
    protected List<? extends SchemaData> readApi(ReaderConfiguration readerConfiguration) {
        return null;
    }

    @Override
    protected ReaderConfiguration buildConvertConfiguration(String resName, SchemaProperties schemaProperties, SchemaPattern schemaPattern) {
        return null;
    }

//
//    @Override
//    protected List<SchemaData> readApi(String res, Map<String, String> heads) {
//
//        return null;
//    }
//
//    @Override
//    protected List<SchemaData> readMvc(String res, Map<String, String> heads) {
//        // 从类路劲加载
...
//        List<SchemaPatternable> schemaPatternables = new ArrayList<>();
...
//            schemaPatternables.add(databaseProperties);
//        }
//        return schemaPatternables;
//    }
