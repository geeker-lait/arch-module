package org.arch.framework.automate.generater.service.xmind.parser;
...
public class ZipUtils {
    ...
    /**
     * 找到压缩文件中匹配的子文件，返回的为getContents("comments.xml",unzip)
     * @param subFileNames
     * @param fileName
     */
    public static Map<String,String> getContents(List<String> subFileNames, String fileName,String extractFileDir) throws IOException {
