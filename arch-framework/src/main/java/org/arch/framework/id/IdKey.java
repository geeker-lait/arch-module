...
public enum IdKey {
    APP_ID("id.app.", 1, TimeUnit.DAYS, "", "%1$06d"),
    // 账户
    ACCOUNT_ID("id.account.", 60, TimeUnit.MILLISECONDS, "1", "%1$08d"),
    // 用户
    USER_ID("id.user.", 60, TimeUnit.MILLISECONDS, "2", "%1$08d"),
    // 绑卡
    BANGKCARD_ID("id.bankcard.", 60, TimeUnit.MILLISECONDS, "2", "%1$08d"),
    // 产品
    PRODUCT_ID("id.product.", 60, TimeUnit.MILLISECONDS, "3", "%1$08d"),
    // 会员
    MEMBER_ID("id.member.", 60, TimeUnit.MILLISECONDS, "4", "%1$08d"),
    // 订单
    ORDER_ID("id.order.", 60, TimeUnit.MILLISECONDS, "5", "%1$08d"),
    // 商户
    MERCHANT_ID("id.merchant.", 60, TimeUnit.MILLISECONDS, "6", "%1$08d"),
    /**
     * 支付系统ID
     */
    ...
    // 推荐ID
    RECOMMEND("id.recommend.", 60, TimeUnit.MILLISECONDS, "21", "%1$08d");
