...
public interface CrudRest<R, ID extends Serializable, DTO> {
     ...
     */
    @PostMapping
    DTO save(@Valid @RequestBody R r);
    ...
    Boolean deleteAllById(@RequestBody List<ID> ids);
     ...
     */
    @PutMapping
    Boolean updateById(@RequestBody @Valid R request);
