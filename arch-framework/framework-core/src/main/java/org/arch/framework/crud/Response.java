...
public class Response<T> {
    ...
    public static <T> Response<T> success(T data) {
        return new Response<T>(ResponseStatusCode.SUCCESS.getCode(), ResponseStatusCode.SUCCESS.getMessage(), data);
    }
    ...
    public static <T> Response<T> failed(StatusCode statusCode) {
        return new Response<T>(statusCode.getCode(), statusCode.getMessage(), null);
    }
    ...
    public static <T> Response<T> unauthorized(T data) {
        return new Response<T>(ResponseStatusCode.UNAUTHORIZED.getCode(), ResponseStatusCode.UNAUTHORIZED.getMessage(), data);
    }
    ...
    public static <T> Response<T> forbidden(T data) {
        return new Response<T>(ResponseStatusCode.FORBIDDEN.getCode(), ResponseStatusCode.FORBIDDEN.getMessage(), data);
    }
    ...
    public static <T> Response<T> error(StatusCode code) {
        return new Response(code.getCode(), code.getMessage());
    }
