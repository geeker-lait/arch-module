...
public class HttpUtils {
    ...
    private final static int SOCKET_TIME_OUT = 5 * 1000;
    /**
     * 向指定 URL 发送GET方法的请求
     *
     * @param url   发送请求的 URL
    ...
    public static String doPostJson(String url, String json) throws Exception {
        ...
        String resultString = "";
        try {
            log.debug("HttpClientUtil>doPostJson[url="+url+",json="+json+"]");
            // 创建Http Post请求
            ...
            log.info("HttpClientUtil>doPostJson[resultString="+resultString+"]");
        } catch (Exception e) {
            e.printStackTrace();
