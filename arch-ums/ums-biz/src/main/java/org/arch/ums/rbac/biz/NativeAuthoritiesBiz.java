...
import org.arch.ums.account.biz.RoleGroupBiz;
import org.arch.ums.account.biz.RoleMenuBiz;
import org.arch.ums.account.biz.RolePermissionBiz;
import org.arch.ums.account.biz.RoleResourceBiz;
...
public class NativeAuthoritiesBiz implements AuthoritiesService {

    private final RoleMenuBiz roleMenuBiz;
    private final RoleGroupBiz roleGroupBiz;
    private final RoleResourceBiz roleResourceBiz;
    ...
    public Map<String, Map<String, Set<String>>> getAllGroupRolesOfAllTenant() {
        ...
        return this.roleGroupBiz.listAllGroups();
    }
    ...
    public Map<String, Map<String, Set<String>>> getGroupRolesByGroupIdOfTenant(@NonNull Integer tenantId,
        ...
        try {
            // Map(tenantAuthority, Map (groupAuthority, Set(roleAuthority)))
            return this.roleGroupBiz.findGroupRolesByGroupIdOfTenant(tenantId,
                                                                     groupId,
                                                                     asList(roleIds));
        }
        catch (Exception e) {
