...
@Slf4j
@Service
public class BizRoleGroupService extends RoleGroupService {
    private final RoleService roleService;
    private final GroupService groupService;

    public BizRoleGroupService(RoleGroupDao roleGroupDao, RoleService roleService, GroupService groupService, RoleService roleService1, GroupService groupService1) {
        super(roleGroupDao);
