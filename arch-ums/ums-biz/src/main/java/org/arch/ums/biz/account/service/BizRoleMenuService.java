...
@Slf4j
@Service
public class BizRoleMenuService extends RoleMenuService {

    private final MenuService menuService;
    private final BizAuthClientService bizAuthClientService;

    public BizRoleMenuService(RoleMenuDao roleMenuDao, MenuService menuService,
