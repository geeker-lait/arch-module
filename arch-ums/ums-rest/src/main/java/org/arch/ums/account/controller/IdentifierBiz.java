...
import org.arch.ums.biz.account.service.BizIdentifierService;
...
public class IdentifierBiz implements CrudBiz<IdentifierRequest, Identifier, Long, IdentifierSearchDto, IdentifierService> {

    private final TenantContextHolder tenantContextHolder;
    private final BizIdentifierService bizIdentifierService;
    ...
    public Response<List<Boolean>> exists(@RequestParam(value = "identifiers") List<String> identifiers) {
        ...
        List<Boolean> exists;
        try {
            exists = bizIdentifierService.exists(identifiers, Integer.valueOf(tenantId));
        }
        catch (Exception e) {
    ...
    public Response<AuthLoginDto> loadAccountByIdentifier(@PathVariable(value = "identifier") String identifier) {
        ...
        try {
            authLoginDto = bizIdentifierService.loadAccountByIdentifier(identifier,
    ...
    public Response<AuthLoginDto> register(@Validated AuthRegRequest authRegRequest) {
        ...
        try {
            register = bizIdentifierService.register(authRegRequest);
        }
        catch (Exception e) {
    ...
    public Response<Boolean> deleteById(@PathVariable(value = "id") Long id) {
        ...
        try {
            ...
            // 逻辑删除
            boolean deleteByIdResult = bizIdentifierService.deleteById(id);
    ...
    public Response<Boolean> logicDeleteByIdentifier(@PathVariable(value = "identifier") String identifier,
        ...
        try {
            // 逻辑删除
            Response<Boolean> success = bizIdentifierService.logicDeletedByIdentifier(token.getTenantId(), identifier);
    ...
    public Response<Boolean> unbinding(@PathVariable(value = "aid") Long aid,
        ...
        try {
            // 解绑
            return Response.success(bizIdentifierService.unbinding(identifier, aid));
        }
        catch (Exception e) {
    ...
    public Response<Boolean> deleteByAccountId(@PathVariable(value = "accountId") Long accountId, TokenInfo token) {
        ...
        try {
            return Response.success(bizIdentifierService.deleteByAccountId(accountId, token.getTenantId()));
        }
        catch (Exception e) {
    ...
    public Response<Map<String, List<Auth2ConnectionDto>>> listAllConnections(
        ...
        try {
            return Response.success(this.bizIdentifierService.listAllConnections(accountId, token.getTenantId()));
        }
        catch (Exception e) {
    ...
    public Response<List<IdentifierSearchDto>> find(@RequestBody @Valid IdentifierRequest request, TokenInfo token) {
        ...
        try {
            ...
            return Response.success(identifierList.stream().map(this::convertReturnDto).collect(Collectors.toList()));
        }
        catch (Exception e) {
            log.error(e.getMessage(), e);
            return Response.error(FAILED.getCode(), e.getMessage());
