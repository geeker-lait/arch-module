...
import org.arch.ums.biz.account.service.BizRoleGroupService;
...
public class RoleGroupBiz implements CrudBiz<RoleGroupRequest, RoleGroup, Long, RoleGroupSearchDto, RoleGroupService> {

    private final TenantContextHolder tenantContextHolder;
    private final BizRoleGroupService bizRoleGroupService;
    ...
    public Response<List<RoleGroupSearchDto>> find(@RequestBody @Valid RoleGroupRequest request, TokenInfo token) {
        ...
        try {
            ...
            return Response.success(roleGroupList.stream().map(this::convertReturnDto).collect(Collectors.toList()));
        }
        catch (Exception e) {
            log.error(e.getMessage(), e);
            return Response.error(FAILED.getCode(), e.getMessage());
    ...
    public Response<Map<String, Map<String, Set<String>>>> listAllGroups() {
        try {
            return Response.success(this.bizRoleGroupService.listAllGroups());
        }
        catch (Exception e) {
            log.error(e.getMessage(),e);
            return Response.error(FAILED.getCode(), e.getMessage());
    ...
    public Response<Map<String, Map<String, Set<String>>>> findGroupRolesByGroupIdOfTenant(
        ...
        try {
            return Response.success(this.bizRoleGroupService.findGroupRolesByGroupIdOfTenant(tenantId, groupId, roleIds));
        }
        catch (Exception e) {
            log.error(e.getMessage(),e);
            return Response.error(FAILED.getCode(), e.getMessage());
    ...
    public Response<Set<String>> findRolesByGroupIdOfTenant(@PathVariable(value = "tenantId") Long tenantId,
                                                            @PathVariable(value = "groupId") Long groupId) {
        try {
            return Response.success(this.bizRoleGroupService.findRolesByGroupIdOfTenant(tenantId, groupId));
        }
        catch (Exception e) {
            log.error(e.getMessage(),e);
            return Response.error(FAILED.getCode(), e.getMessage());
    ...
    public Response<Boolean> updateRolesByGroupIdOfTenant(@PathVariable(value = "tenantId") Long tenantId,
        ...
        try {
            return Response.success(this.bizRoleGroupService.updateRolesByGroupIdOfTenant(tenantId, groupId, roleIds));
        }
        catch (Exception e) {
            log.error(e.getMessage(),e);
            return Response.error(FAILED.getCode(), e.getMessage());
