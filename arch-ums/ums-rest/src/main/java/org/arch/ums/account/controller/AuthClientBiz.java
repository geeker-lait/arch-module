...
import org.arch.ums.biz.account.service.BizAuthClientService;
...
public class AuthClientBiz implements CrudBiz<AuthClientRequest, AuthClient, Long, AuthClientSearchDto, AuthClientService> {
    ...
    public Response<Set<String>> getScopesByClientIdAndClientSecret(@RequestParam("clientId") String clientId,
        ...
        Set<String> scopes;
        try {
            scopes = bizAuthClientService.getScopesByClientIdAndClientSecret(clientId, clientSecret);
        }
        catch (Exception e) {
    ...
    public Response<Map<Integer, Map<String, AuthClientVo>>> getAllScopes() {
        ...
        try {
            allScopes = bizAuthClientService.getAllScopes();
        }
        catch (Exception e) {
    ...
    public Response<List<AuthClientSearchDto>> find(@RequestBody @Valid AuthClientRequest request, TokenInfo token) {
        ...
        try {
            ...
            return Response.success(authClientList.stream().map(this::convertReturnDto).collect(Collectors.toList()));
        }
        catch (Exception e) {
            log.error(e.getMessage(), e);
            return Response.error(FAILED.getCode(), e.getMessage());
