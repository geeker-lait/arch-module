...
public class MobileSegmentBiz implements CrudBiz<MobileSegmentRequest, MobileSegment, Long, MobileSegmentSearchDto, MobileSegmentService> {
    ...
    public MobileSegmentService getCrudService() {
        return bizMobileSegmentService;
    }
    ...
    public Response<List<MobileSegmentSearchDto>> find(@RequestBody @Valid MobileSegmentRequest request, TokenInfo token) {
        ...
        try {
            ...
            return Response.success(mobileSegmentList.stream().map(this::convertReturnDto).collect(Collectors.toList()));
        }
        catch (Exception e) {
            log.error(e.getMessage(), e);
            return Response.error(FAILED.getCode(), e.getMessage());
    ...
    public Response<Boolean> insertOnDuplicateKeyUpdate(@Valid @RequestBody List<MobileSegmentRequest> requestList) {
        try {
            ...
            return Response.success(bizMobileSegmentService.insertOnDuplicateKeyUpdateBatch(tList));
        }
        catch (Exception e) {
            log.error(e.getMessage(), e);
            return Response.error(FAILED.getCode(), e.getMessage());
