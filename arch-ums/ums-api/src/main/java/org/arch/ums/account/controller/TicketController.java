...
public class TicketController implements CrudController<Ticket, java.lang.Long, TicketSearchDto, TicketService> {
    ...
    @NonNull
    @GetMapping("/single")
    public Response<Ticket> findOne(@RequestBody Ticket entity, TokenInfo token) {
        try {
            resolver(token, entity);
            TicketSearchDto searchDto = convertSearchDto(entity);
            Ticket t = getCrudService().findOneByMapParams(searchDto.getSearchParams());
    ...
    @NonNull
    @GetMapping("/find")
    public Response<List<Ticket>> find(@RequestBody Ticket t, TokenInfo token) {
        resolver(token, t);
        TicketSearchDto searchDto = convertSearchDto(t);
        try {
    ...
    public Response<IPage<Ticket>> page(@RequestBody Ticket entity,
