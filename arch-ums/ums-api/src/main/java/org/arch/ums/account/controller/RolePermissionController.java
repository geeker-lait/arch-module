...
public class RolePermissionController implements CrudController<RolePermission, java.lang.Long, RolePermissionSearchDto, RolePermissionService> {
    ...
    @NonNull
    @GetMapping("/single")
    public Response<RolePermission> findOne(@RequestBody RolePermission entity, TokenInfo token) {
        try {
            resolver(token, entity);
            RolePermissionSearchDto searchDto = convertSearchDto(entity);
            RolePermission t = getCrudService().findOneByMapParams(searchDto.getSearchParams());
    ...
    @NonNull
    @GetMapping("/find")
    public Response<List<RolePermission>> find(@RequestBody RolePermission t, TokenInfo token) {
        resolver(token, t);
        RolePermissionSearchDto searchDto = convertSearchDto(t);
        try {
    ...
    public Response<IPage<RolePermission>> page(@RequestBody RolePermission entity,
    ...
    public Response<Boolean> updateResourcesByRoleIdOfTenant(@PathVariable(value = "tenantId") Long tenantId,
        ...
        try {
            return Response.success(this.rolePermissionService.updateResourcesByRoleIdOfTenant(tenantId, roleId,
                                                                                               permissionIds));
        }
        catch (Exception e) {
            log.error(e.getMessage(),e);
    ...
    public Response<Boolean> updateResourcesByRoleIdOfScopeId(@PathVariable(value = "scopeId") Long scopeId,
        ...
        try {
            return Response.success(this.rolePermissionService.updateResourcesByRoleIdOfScopeId(token.getTenantId()
                                                                                                     .longValue(),
                                                                                                scopeId,
                                                                                                roleId,
                                                                                                permissionIds));
    ...
    @NonNull
    public Response<List<Permission>> findAllResourcesByRoleIdOfTenant(@PathVariable(value = "tenantId") Long tenantId,
                                                                       @PathVariable(value = "roleId") Long roleId) {
        try {
            return Response.success(this.rolePermissionService.findAllResourcesByRoleIdOfTenant(tenantId, roleId));
        }
        catch (Exception e) {
            log.error(e.getMessage(),e);
            return Response.error(FAILED.getCode(), e.getMessage());
    ...
    @NonNull
    public Response<List<Permission>> findAllResourcesByRoleIdOfScopeId(@PathVariable(value = "scopeId") Long scopeId,
                                                                        @PathVariable(value = "roleId") Long roleId) {
        try {
            Long tenantId = Long.valueOf(tenantContextHolder.getTenantId());
            return Response.success(this.rolePermissionService.findAllResourcesByRoleIdOfScopeId(tenantId,
                                                                                                 scopeId,
                                                                                                 roleId));
        }
        catch (Exception e) {
