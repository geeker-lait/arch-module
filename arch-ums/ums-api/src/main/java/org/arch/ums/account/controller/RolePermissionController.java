...
public class RolePermissionController implements CrudController<RolePermissionRequest, RolePermission, java.lang.Long, RolePermissionSearchDto, RolePermissionService> {
    ...
    public Response<List<PermissionSearchDto>> findAllResourcesByRoleIdOfTenant(@PathVariable(value = "tenantId") Long tenantId,
                                                                                @PathVariable(value = "roleId") Long roleId) {
        try {
            List<Permission> permissionList = this.rolePermissionService.findAllResourcesByRoleIdOfTenant(tenantId, roleId);
    ...
    public Response<List<PermissionSearchDto>> findAllResourcesByRoleIdOfScopeId(@PathVariable(value = "scopeId") Long scopeId,
        ...
        try {
            ...
            List<Permission> permissionList = this.rolePermissionService.findAllResourcesByRoleIdOfScopeId(tenantId,
                                                                                                           scopeId,
                                                                                                           roleId);
            List<PermissionSearchDto> menuSearchDtoList =
                    permissionList.stream()
