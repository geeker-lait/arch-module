...
public class RelationshipController implements CrudController<RelationshipRequest, Relationship, java.lang.Long, RelationshipSearchDto, RelationshipService> {
    ...
    public Response<RelationshipSearchDto> save(@Valid @RequestBody RelationshipRequest request, TokenInfo token) {
        ...
        return Response.success(convertSearchDto(relationship));
    }
