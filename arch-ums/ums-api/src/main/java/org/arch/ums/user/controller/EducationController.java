...
public class EducationController implements CrudController<Education, java.lang.Long, EducationSearchDto, EducationService> {
    ...
    @NonNull
    @GetMapping("/single")
    public Response<Education> findOne(@RequestBody Education entity, TokenInfo token) {
        try {
            resolver(token, entity);
            EducationSearchDto searchDto = convertSearchDto(entity);
            Education t = getCrudService().findOneByMapParams(searchDto.getSearchParams());
    ...
    @NonNull
    @GetMapping("/find")
    public Response<List<Education>> find(@RequestBody Education t, TokenInfo token) {
        resolver(token, t);
        EducationSearchDto searchDto = convertSearchDto(t);
        try {
    ...
    public Response<IPage<Education>> page(@RequestBody Education entity,
