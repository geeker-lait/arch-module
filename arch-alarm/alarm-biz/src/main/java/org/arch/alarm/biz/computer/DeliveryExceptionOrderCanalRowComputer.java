...
@Component
@Slf4j
public class DeliveryExceptionOrderCanalRowComputer extends AbstractCanalRowComputer<DeliveryOrderRegData> {

    @Override
    public ComputTable getComputTable() {
        return ComputTable.OFS_DELIVERY_CENTER_T_DELIVERY_EXCEPTION_ORDER;
    }
