...
//import org.arch.framework.utils.BankInfoUtil;
...
// */
//@Data
//public class TransterRequest implements DirectiveRequest {
...
//        transterRequest.setAccountNo("123123213");
//        transterRequest.setAccountName("lait");
//
//        Map<String, Object> paramMap = new HashMap<>();
//        transterRequest.convert(paramMap, null);
//        System.out.println(transterRequest.toJsonString());
//    }
//
//    @Override
//    public DirectiveRequest convert(Map<String, Object> map, PayRequest payRequest) {
//        // 首先统一处理相同字段
//        TransterRequest transterRequest = JSON.parseObject(JSON.toJSONString(map), TransterRequest.class);
//        BeanUtils.copyProperties(transterRequest, this);
//
