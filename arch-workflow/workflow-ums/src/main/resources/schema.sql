CREATE DATABASE IF NOT EXISTS workflow_ums DEFAULT CHARSET utf8 COLLATE utf8_general_ci$$
USE workflow_ums$$
...
-- 租户表
-- ----------------------------
CREATE TABLE IF NOT EXISTS `ums_tenant`(
...
-- 群组表
-- ----------------------------
CREATE TABLE IF NOT EXISTS `ums_group`  (
  `id_` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键ID',
...
-- 用户与群组对应表
-- ----------------------------
CREATE TABLE IF NOT EXISTS `ums_user_group`  (
  `id_` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键ID',
