...
import org.arch.workflow.flowable.rest.instance.ProcessInstancePaginateList;
import org.arch.workflow.flowable.rest.instance.ProcessInstanceStartRequest;
...
public class ProcessInstanceResource extends BaseProcessInstanceResource {
    ...
    public ProcessInstanceStartResponse startProcessInstance(@RequestBody ProcessInstanceStartRequest request) {
        ...
        org.flowable.common.engine.impl.identity.Authentication.setAuthenticatedUserId(Authentication.getUserId());
