 ...
 * 注意: 与 ums-api 模块的 {@code UmsAccountRoleGroupFeignService} 逻辑相同, 添加接口时需一同修改.
 *
 * @author YongWu zheng
...
public interface RoleGroupApi extends FeignApi<RoleGroupSearchDto, RoleGroupRequest, Long> {
