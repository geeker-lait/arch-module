package org.arch.form.core.ddl;
...
public abstract class DDLOperate implements InitializingBean {
    ...
    protected <R> R execute(DatabaseProperties properties, Function<Connection, R> function) {
        try (Connection connection = getConnection(properties);) {
            ...
            log.warn("The database connection failed or the operation failed, business properties exception please check jdbcProperties, databaseProperties:{}", properties, e);
     ...
     * @return
     */
    public abstract List<Table> getDatabaseProperties(DatabaseProperties properties, String database);
