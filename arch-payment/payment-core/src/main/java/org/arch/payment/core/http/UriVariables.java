...
public class UriVariables {
     ...
     * @return 匹配完的url
     * <code>
     * System.out.println(getUri(&quot;http://baidu.com/{a}/ba/{a1}?{bb}={a1}&quot;, &quot;no1&quot;, &quot;no2&quot;, &quot;no3&quot;, &quot;no4&quot;));
     * 结果 http://baidu.com/no1/ba/no2?no3=no4
     * </code>
     */
     ...
     * System.out.println(getUri(&quot;http://baidu.com/{a}/ba/{a1}?{bb}={a1}&quot;, uriVariable));
     * 结果 http://baidu.com/no1/ba/no2?no3=no2
     * </code>
     */
    ...
    private static void putKeyValueToMap(StringBuilder temp, boolean isKey, String key, Map<String, Object> map) {
        if (isKey) {
            key = temp.toString();
            if (key.length() == 0) {
                throw new PayException(new PayException("QString format illegal", "内容格式有误"));
            }
            map.put(key, "");
        } else {
            if (key.length() == 0) {
