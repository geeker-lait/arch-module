...
import org.arch.form.api.dto.FormBizSearchDto;
...
public class FormBizController implements CrudBiz<FormBizRequest, FormBiz, Long, FormBizSearchDto, FormBizSearchDto,
        FormBizService> {
