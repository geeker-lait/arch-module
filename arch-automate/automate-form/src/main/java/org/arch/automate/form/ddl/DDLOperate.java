package org.arch.automate.form.ddl;
...
public abstract class DDLOperate implements InitializingBean {
     ...
     * @return
     */
    protected <R> R execute(DatabaseConfiguration properties, Function<Connection, R> function) {
     ...
     * @return
     */
    public static DDLOperate selectDDLOperate(DatabaseConfiguration properties) {
        if (properties == null || StringUtils.isBlank(properties.getDriver()) || StringUtils.isBlank(properties.getUrl()) ||
                StringUtils.isBlank(properties.getUrl()) || StringUtils.isBlank(properties.getUsername()) || StringUtils.isBlank(properties.getPassword())) {
     ...
     * @return
     */
    private Connection getConnection(DatabaseConfiguration properties) throws ClassNotFoundException, SQLException {
        if (properties == null || StringUtils.isBlank(properties.getDriver()) || StringUtils.isBlank(properties.getUrl()) ||
                StringUtils.isBlank(properties.getUrl()) || StringUtils.isBlank(properties.getUsername()) || StringUtils.isBlank(properties.getPassword())) {
            return null;
        }
     ...
     * @return
     */
    protected abstract String getDbUrl(DatabaseConfiguration properties);
     ...
     * @return
     */
    protected abstract String getDriver(DatabaseConfiguration properties);
     ...
     * @return
     */
    public abstract int createDatabase(DatabaseConfiguration properties, String database);
     ...
     * @return
     */
    public abstract int dropDatabase(DatabaseConfiguration properties, String database);
     ...
     * @return
     */
    public abstract int dropTable(DatabaseConfiguration properties, String database, String tableName);
     ...
     * @return
     */
    public abstract int createTable(DatabaseConfiguration properties, DefinitionTableDto record);
     ...
     * @return
     */
    public abstract List<Table> getDatabaseProperties(DatabaseConfiguration properties, String database);
