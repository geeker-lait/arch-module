...
import org.arch.automate.properties.DependencieProterties;
        ...
        if (modules == null || modules.size() == 0) {
            ...
            pomProperties.getDocumentTyps().forEach(docTyp -> {
                ...
                if (buildable != null) {
                    ...
                    log.error("buildable is null ,please implements org.arch.automate.core.Buildable and properties it as a spring component");
                }
            });
        } else {
